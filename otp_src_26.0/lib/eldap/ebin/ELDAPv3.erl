...
-asn1_info([{vsn,'5.1'},
 ...
 {cwd,"/buildroot/otp/lib/eldap/src"},
 {outdir,"/buildroot/otp/lib/eldap/src/../ebin"},
 {i,"/buildroot/otp/lib/eldap/src/../include"},
 {i,"/buildroot/otp/lib/eldap/src/../ebin"},
 warnings_as_errors,warnings_as_errors,legacy_erlang_types,debug_info,
 {i,"."},
 {i,"/buildroot/otp/lib/eldap/src/../asn1"}]}]).
...
encode_disp('RealSearchControlValue', Data) -> enc_RealSearchControlValue(Data);
...
decode_disp('RealSearchControlValue', Data) -> dec_RealSearchControlValue(Data);
...
%%================================
enc_RealSearchControlValue(Val) ->
    enc_RealSearchControlValue(Val, [<<48>>]).

enc_RealSearchControlValue(Val, TagIn) ->
{_,Cindex1,Cindex2} = Val,
...
%%-------------------------------------------------
%% attribute cookie(2) with type OCTET STRING
%%-------------------------------------------------
   {EncBytes2,EncLen2} = encode_restricted_string(Cindex2, [<<4>>]),
...
dec_RealSearchControlValue(Tlv) ->
   dec_RealSearchControlValue(Tlv, [16]).

dec_RealSearchControlValue(Tlv, TagIn) ->
   %%-------------------------------------------------
   %% decode tag and length 
   %%-------------------------------------------------
Tlv1 = match_tags(Tlv, TagIn),
...
case Tlv3 of [] -> true; _ -> true end, % ... extra fields skipped
Res1 = {'RealSearchControlValue',Term1,Term2},
Res1.
maxInt() ->
2147483647.
