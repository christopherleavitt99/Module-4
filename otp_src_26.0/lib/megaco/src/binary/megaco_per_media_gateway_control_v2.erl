...
{Acc1,Buf1} = dec_fragment42(V1@V0, V1@Buf1, Acc),
if V1@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment43(V2@V0, V2@Buf1, Acc),
if V2@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment44(V3@V0, V3@Buf1, Acc),
if V3@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment45(V4@V0, V4@Buf1, Acc),
if V4@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment46(V5@V0, V5@Buf1, Acc),
if V5@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment47(V6@V0, V6@Buf1, Acc),
if V6@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment48(V7@V0, V7@Buf1, Acc),
if V7@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment49(V8@V0, V8@Buf1, Acc),
if V8@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment50(V9@V0, V9@Buf1, Acc),
if V9@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment51(V10@V0, V10@Buf1, Acc),
if V10@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment52(V11@V0, V11@Buf1, Acc),
if V11@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment53(V12@V0, V12@Buf1, Acc),
if V12@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment54(V13@V0, V13@Buf1, Acc),
if V13@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment55(V14@V0, V14@Buf1, Acc),
if V14@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment56(V15@V0, V15@Buf1, Acc),
if V15@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment57(V16@V0, V16@Buf1, Acc),
if V16@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment58(V17@V0, V17@Buf1, Acc),
if V17@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment59(V18@V0, V18@Buf1, Acc),
if V18@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment60(V19@V0, V19@Buf1, Acc),
if V19@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment61(V20@V0, V20@Buf1, Acc),
if V20@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment62(V21@V0, V21@Buf1, Acc),
if V21@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment63(V22@V0, V22@Buf1, Acc),
if V22@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment64(V23@V0, V23@Buf1, Acc),
if V23@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment65(V24@V0, V24@Buf1, Acc),
if V24@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment66(V25@V0, V25@Buf1, Acc),
if V25@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment67(V26@V0, V26@Buf1, Acc),
if V26@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment68(V27@V0, V27@Buf1, Acc),
if V27@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment69(V28@V0, V28@Buf1, Acc),
if V28@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment70(V29@V0, V29@Buf1, Acc),
if V29@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment71(V30@V0, V30@Buf1, Acc),
if V30@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment72(V31@V0, V31@Buf1, Acc),
if V31@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment73(V32@V0, V32@Buf1, Acc),
if V32@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment74(V33@V0, V33@Buf1, Acc),
if V33@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment75(V34@V0, V34@Buf1, Acc),
if V34@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment76(V35@V0, V35@Buf1, Acc),
if V35@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment77(V36@V0, V36@Buf1, Acc),
if V36@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment78(V37@V0, V37@Buf1, Acc),
if V37@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment79(V38@V0, V38@Buf1, Acc),
if V38@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment80(V39@V0, V39@Buf1, Acc),
if V39@V0 >= 16384 ->
...
V40@Conv10 = binary_to_list(V40@V0),
{V40@Conv10,V40@Buf1}
end,
...
<<_:V41@Pad3,0:1,V41@V5:7,V41@V7:V41@V5/binary-unit:8,V41@Buf8/bitstring>> ->
{V41@V7,V41@Buf8};
<<_:V41@Pad3,1:1,0:1,V41@V6:14,V41@V8:V41@V6/binary-unit:8,V41@Buf9/bitstring>> ->
{V41@V8,V41@Buf9};
<<_:V41@Pad3,1:1,1:1,V41@V6:6,V41@Buf7/bitstring>> ->
{V41@V8,V41@Buf9}  = decode_fragmented(V41@V6, V41@Buf7, 8),
{V41@V8,V41@Buf9}
end,
V41@Conv10 = binary_to_list(V41@V0),
{V41@Conv10,V41@Buf1}
end,
...
{Term,Remain} = begin
<<V42@V0:1/binary-unit:8,V42@Buf1/bitstring>> = Bytes,
V42@Conv2 = binary_to_list(V42@V0),
{V42@Conv2,V42@Buf1}
end,
...
<<0:1,V43@V3:4/unsigned-unit:1,V43@Buf4/bitstring>> ->
V43@Int5 = case V43@V3 of
0 -> v18;
1 -> v22;
2 -> v22bis;
3 -> v32;
...
7 -> v91;
8 -> synchISDN;
_ -> exit({error,{asn1,{decode_enumerated,V43@V3}}})
end,
{V43@Int5,V43@Buf4};
<<1:1,V43@Buf2/bitstring>> ->
{V43@V3,V43@Buf4} = case V43@Buf2 of
<<0:1,V43@V6:6,V43@Buf7/bitstring>> ->
{V43@V6,V43@Buf7};
<<1:1,V43@Buf5/bitstring>> ->
V43@Pad9 = bit_size(V43@Buf5) band 7,
{V43@V6,V43@Buf7} = case V43@Buf5 of
<<_:V43@Pad9,0:1,V43@V11:7,V43@Buf12/bitstring>> when V43@V11 =/= 0 ->
{V43@V11,V43@Buf12};
<<_:V43@Pad9,1:1,0:1,V43@V12:14,V43@Buf13/bitstring>> when V43@V12 =/= 0 ->
{V43@V12,V43@Buf13};
<<_:V43@Pad9,1:1,1:1,V43@V12:6,V43@Buf13/bitstring>> when V43@V12 =/= 0 ->
V43@Mul14 = V43@V12 * 16384,
{V43@Mul14,V43@Buf13}
end,
<<V43@V15:V43@V6/unit:8,V43@Buf16/bitstring>> = V43@Buf7,
{V43@V15,V43@Buf16}
end,
V43@Int17 = case V43@V3 of
_ -> {asn1_enum,V43@V3}
end,
{V43@Int17,V43@Buf4}
end,
