%% Generated by the Erlang ASN.1 PER (aligned) compiler. Version: 5.1
...
{V11@V12,V11@Buf13};
<<_:V11@Pad9,1:1,1:1,V11@V12:6,V11@Buf13/bitstring>> when V11@V12 =/= 0 ->
V11@Mul14 = V11@V12 * 16384,
{V11@Mul14,V11@Buf13}
end,
<<V11@V15:V11@V6/unit:8,V11@Buf16/bitstring>> = V11@Buf7,
{V11@V15,V11@Buf16}
end,
V11@Int17 = case V11@V3 of
_ -> {asn1_enum,V11@V3}
end,
{V11@Int17,V11@Buf4}
end,
...
if Enc1@len < 128 ->
[align,
Enc1@len|[enc_IndAudPropertyParm(Comp) || Comp <- Val]];
Enc1@len < 16384 ->
[align,
<<2:2,Enc1@len:14>>|[enc_IndAudPropertyParm(Comp) || Comp <- Val]];
true ->
begin
Enc1@fn = fun(Comp) -> enc_IndAudPropertyParm(Comp) end,
encode_fragmented_sof(Enc1@fn, Val, Enc1@len)
end
end.
...
{V7@V12,V7@Buf13};
<<_:V7@Pad9,1:1,1:1,V7@V12:6,V7@Buf13/bitstring>> when V7@V12 =/= 0 ->
V7@Mul14 = V7@V12 * 16384,
{V7@Mul14,V7@Buf13}
end,
<<V7@V15:V7@V6/unit:8,V7@Buf16/bitstring>> = V7@Buf7,
{V7@V15,V7@Buf16}
end,
V7@Int17 = case V7@V3 of
_ -> {asn1_enum,V7@V3}
end,
{V7@Int17,V7@Buf4}
end,
...
{V8@V12,V8@Buf13};
<<_:V8@Pad9,1:1,1:1,V8@V12:6,V8@Buf13/bitstring>> when V8@V12 =/= 0 ->
V8@Mul14 = V8@V12 * 16384,
{V8@Mul14,V8@Buf13}
end,
<<V8@V15:V8@V6/unit:8,V8@Buf16/bitstring>> = V8@Buf7,
{V8@V15,V8@Buf16}
end,
V8@Int17 = case V8@V3 of
_ -> {asn1_enum,V8@V3}
end,
{V8@Int17,V8@Buf4}
end,
...
if Enc1@len < 128 ->
[align,
Enc1@len|[enc_IndAudStreamDescriptor(Comp) || Comp <- Val]];
Enc1@len < 16384 ->
[align,
<<2:2,Enc1@len:14>>|[enc_IndAudStreamDescriptor(Comp) || Comp <- Val]];
true ->
begin
Enc1@fn = fun(Comp) -> enc_IndAudStreamDescriptor(Comp) end,
encode_fragmented_sof(Enc1@fn, Val, Enc1@len)
end
end.
...
if Enc1@len < 128 ->
[align,
Enc1@len|[enc_IndAuditParameter(Comp) || Comp <- Val]];
Enc1@len < 16384 ->
[align,
<<2:2,Enc1@len:14>>|[enc_IndAuditParameter(Comp) || Comp <- Val]];
true ->
begin
Enc1@fn = fun(Comp) -> enc_IndAuditParameter(Comp) end,
encode_fragmented_sof(Enc1@fn, Val, Enc1@len)
end
end.
...
Enc2@len < 16384 ->
[align,
<<2:2,Enc2@len:14>>|[if Comp bsr 32 =:= 0 ->
begin
Comp@bin = binary:encode_unsigned(Comp),
Comp@bin_size0 = byte_size(Comp@bin),
Comp@bin_size = Comp@bin_size0 - 1,
...
true ->
begin
Enc2@fn = fun(Comp) -> if Comp bsr 32 =:= 0 ->
begin
Comp@bin = binary:encode_unsigned(Comp),
Comp@bin_size0 = byte_size(Comp@bin),
Comp@bin_size = Comp@bin_size0 - 1,
...
dec_components37(Bytes, []).


dec_ContextRequest_contextList(Bytes) ->
dec_components38(Bytes, []).
...
{Acc1,Buf1} = dec_fragment45(V1@V0, V1@Buf1, Acc),
if V1@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment46(V2@V0, V2@Buf1, Acc),
if V2@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment47(V3@V0, V3@Buf1, Acc),
if V3@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment48(V4@V0, V4@Buf1, Acc),
if V4@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment49(V5@V0, V5@Buf1, Acc),
if V5@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment50(V6@V0, V6@Buf1, Acc),
if V6@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment51(V7@V0, V7@Buf1, Acc),
if V7@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment52(V8@V0, V8@Buf1, Acc),
if V8@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment53(V9@V0, V9@Buf1, Acc),
if V9@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment54(V10@V0, V10@Buf1, Acc),
if V10@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment55(V11@V0, V11@Buf1, Acc),
if V11@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment56(V12@V0, V12@Buf1, Acc),
if V12@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment57(V13@V0, V13@Buf1, Acc),
if V13@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment58(V14@V0, V14@Buf1, Acc),
if V14@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment59(V15@V0, V15@Buf1, Acc),
if V15@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment60(V16@V0, V16@Buf1, Acc),
if V16@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment61(V17@V0, V17@Buf1, Acc),
if V17@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment62(V18@V0, V18@Buf1, Acc),
if V18@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment63(V19@V0, V19@Buf1, Acc),
if V19@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment64(V20@V0, V20@Buf1, Acc),
if V20@V0 >= 16384 ->
dec_components27(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.
...
{Acc1,Buf1} = dec_fragment65(V21@V0, V21@Buf1, Acc),
if V21@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment66(V22@V0, V22@Buf1, Acc),
if V22@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment67(V23@V0, V23@Buf1, Acc),
if V23@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment68(V24@V0, V24@Buf1, Acc),
if V24@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment69(V25@V0, V25@Buf1, Acc),
if V25@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment70(V26@V0, V26@Buf1, Acc),
if V26@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment71(V27@V0, V27@Buf1, Acc),
if V27@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment72(V28@V0, V28@Buf1, Acc),
if V28@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment73(V29@V0, V29@Buf1, Acc),
if V29@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment74(V30@V0, V30@Buf1, Acc),
if V30@V0 >= 16384 ->
dec_components37(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.

dec_components38(Bytes, Acc) ->
%% Length with constraint no
...
{Acc1,Buf1} = dec_fragment75(V31@V0, V31@Buf1, Acc),
if V31@V0 >= 16384 ->
dec_components38(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.

dec_components39(Bytes, Acc) ->
%% Length with constraint no
...
{Acc1,Buf1} = dec_fragment76(V32@V0, V32@Buf1, Acc),
if V32@V0 >= 16384 ->
dec_components39(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.
...
{Acc1,Buf1} = dec_fragment77(V33@V0, V33@Buf1, Acc),
if V33@V0 >= 16384 ->
...
{Acc1,Buf1} = dec_fragment78(V34@V0, V34@Buf1, Acc),
if V34@V0 >= 16384 ->
dec_components40(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.

dec_components41(Bytes, Acc) ->
%% Length with constraint no
V35@Pad3 = bit_size(Bytes) band 7,
{V35@V0,V35@Buf1} = case Bytes of
<<_:V35@Pad3,0:1,V35@V5:7,V35@Buf6/bitstring>> ->
{V35@V5,V35@Buf6};
<<_:V35@Pad3,1:1,0:1,V35@V6:14,V35@Buf7/bitstring>> ->
{V35@V6,V35@Buf7};
<<_:V35@Pad3,1:1,1:1,V35@V6:6,V35@Buf7/bitstring>> ->
V35@Mul8 = V35@V6 * 16384,
{V35@Mul8,V35@Buf7}
end,
{Acc1,Buf1} = dec_fragment79(V35@V0, V35@Buf1, Acc),
if V35@V0 >= 16384 ->
dec_components41(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.

dec_components42(Bytes, Acc) ->
%% Length with constraint no
V36@Pad3 = bit_size(Bytes) band 7,
{V36@V0,V36@Buf1} = case Bytes of
<<_:V36@Pad3,0:1,V36@V5:7,V36@Buf6/bitstring>> ->
{V36@V5,V36@Buf6};
<<_:V36@Pad3,1:1,0:1,V36@V6:14,V36@Buf7/bitstring>> ->
{V36@V6,V36@Buf7};
<<_:V36@Pad3,1:1,1:1,V36@V6:6,V36@Buf7/bitstring>> ->
V36@Mul8 = V36@V6 * 16384,
{V36@Mul8,V36@Buf7}
end,
{Acc1,Buf1} = dec_fragment80(V36@V0, V36@Buf1, Acc),
if V36@V0 >= 16384 ->
dec_components42(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.

dec_components43(Bytes, Acc) ->
%% Length with constraint no
V37@Pad3 = bit_size(Bytes) band 7,
{V37@V0,V37@Buf1} = case Bytes of
<<_:V37@Pad3,0:1,V37@V5:7,V37@Buf6/bitstring>> ->
{V37@V5,V37@Buf6};
<<_:V37@Pad3,1:1,0:1,V37@V6:14,V37@Buf7/bitstring>> ->
{V37@V6,V37@Buf7};
<<_:V37@Pad3,1:1,1:1,V37@V6:6,V37@Buf7/bitstring>> ->
V37@Mul8 = V37@V6 * 16384,
{V37@Mul8,V37@Buf7}
end,
{Acc1,Buf1} = dec_fragment81(V37@V0, V37@Buf1, Acc),
if V37@V0 >= 16384 ->
dec_components43(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.

dec_components44(Bytes, Acc) ->
%% Length with constraint no
V38@Pad3 = bit_size(Bytes) band 7,
{V38@V0,V38@Buf1} = case Bytes of
<<_:V38@Pad3,0:1,V38@V5:7,V38@Buf6/bitstring>> ->
{V38@V5,V38@Buf6};
<<_:V38@Pad3,1:1,0:1,V38@V6:14,V38@Buf7/bitstring>> ->
{V38@V6,V38@Buf7};
<<_:V38@Pad3,1:1,1:1,V38@V6:6,V38@Buf7/bitstring>> ->
V38@Mul8 = V38@V6 * 16384,
{V38@Mul8,V38@Buf7}
end,
{Acc1,Buf1} = dec_fragment82(V38@V0, V38@Buf1, Acc),
if V38@V0 >= 16384 ->
dec_components44(Buf1, Acc1);
true ->
{lists:reverse(Acc1),Buf1}
end.
...
%% Length with constraint no
V39@Pad3 = bit_size(Bytes) band 7,
{V39@V0,V39@Buf1} = case Bytes of
<<_:V39@Pad3,0:1,V39@V5:7,V39@Buf6/bitstring>> ->
{V39@V5,V39@Buf6};
<<_:V39@Pad3,1:1,0:1,V39@V6:14,V39@Buf7/bitstring>> ->
{V39@V6,V39@Buf7};
<<_:V39@Pad3,1:1,1:1,V39@V6:6,V39@Buf7/bitstring>> ->
V39@Mul8 = V39@V6 * 16384,
{V39@Mul8,V39@Buf7}
end,
{Acc1,Buf1} = dec_fragment83(V39@V0, V39@Buf1, Acc),
if V39@V0 >= 16384 ->
...
%% Length with constraint no
V40@Pad3 = bit_size(Bytes) band 7,
{V40@V0,V40@Buf1} = case Bytes of
<<_:V40@Pad3,0:1,V40@V5:7,V40@Buf6/bitstring>> ->
{V40@V5,V40@Buf6};
<<_:V40@Pad3,1:1,0:1,V40@V6:14,V40@Buf7/bitstring>> ->
{V40@V6,V40@Buf7};
<<_:V40@Pad3,1:1,1:1,V40@V6:6,V40@Buf7/bitstring>> ->
V40@Mul8 = V40@V6 * 16384,
{V40@Mul8,V40@Buf7}
end,
{Acc1,Buf1} = dec_fragment84(V40@V0, V40@Buf1, Acc),
if V40@V0 >= 16384 ->
...
%% Length with constraint no
V41@Pad3 = bit_size(Bytes) band 7,
{V41@V0,V41@Buf1} = case Bytes of
<<_:V41@Pad3,0:1,V41@V5:7,V41@Buf6/bitstring>> ->
{V41@V5,V41@Buf6};
<<_:V41@Pad3,1:1,0:1,V41@V6:14,V41@Buf7/bitstring>> ->
{V41@V6,V41@Buf7};
<<_:V41@Pad3,1:1,1:1,V41@V6:6,V41@Buf7/bitstring>> ->
V41@Mul8 = V41@V6 * 16384,
{V41@Mul8,V41@Buf7}
end,
{Acc1,Buf1} = dec_fragment85(V41@V0, V41@Buf1, Acc),
if V41@V0 >= 16384 ->
...
%% Length with constraint no
V42@Pad3 = bit_size(Bytes) band 7,
{V42@V0,V42@Buf1} = case Bytes of
<<_:V42@Pad3,0:1,V42@V5:7,V42@Buf6/bitstring>> ->
{V42@V5,V42@Buf6};
<<_:V42@Pad3,1:1,0:1,V42@V6:14,V42@Buf7/bitstring>> ->
{V42@V6,V42@Buf7};
<<_:V42@Pad3,1:1,1:1,V42@V6:6,V42@Buf7/bitstring>> ->
V42@Mul8 = V42@V6 * 16384,
{V42@Mul8,V42@Buf7}
end,
{Acc1,Buf1} = dec_fragment86(V42@V0, V42@Buf1, Acc),
if V42@V0 >= 16384 ->
...
{Term,Remain} = begin
V43@Pad3 = bit_size(Bytes) band 7,
{V43@V0,V43@Buf1} = case Bytes of
<<_:V43@Pad3,0:1,V43@V5:7,V43@V7:V43@V5/binary-unit:8,V43@Buf8/bitstring>> ->
{V43@V7,V43@Buf8};
<<_:V43@Pad3,1:1,0:1,V43@V6:14,V43@V8:V43@V6/binary-unit:8,V43@Buf9/bitstring>> ->
{V43@V8,V43@Buf9};
<<_:V43@Pad3,1:1,1:1,V43@V6:6,V43@Buf7/bitstring>> ->
{V43@V8,V43@Buf9}  = decode_fragmented(V43@V6, V43@Buf7, 8),
{V43@V8,V43@Buf9}
end,
V43@Conv10 = binary_to_list(V43@V0),
{V43@Conv10,V43@Buf1}
end,
...
{Term,Remain} = begin
V44@Pad3 = bit_size(Bytes) band 7,
{V44@V0,V44@Buf1} = case Bytes of
<<_:V44@Pad3,0:1,V44@V5:7,V44@V7:V44@V5/binary-unit:8,V44@Buf8/bitstring>> ->
{V44@V7,V44@Buf8};
<<_:V44@Pad3,1:1,0:1,V44@V6:14,V44@V8:V44@V6/binary-unit:8,V44@Buf9/bitstring>> ->
{V44@V8,V44@Buf9};
<<_:V44@Pad3,1:1,1:1,V44@V6:6,V44@Buf7/bitstring>> ->
{V44@V8,V44@Buf9}  = decode_fragmented(V44@V6, V44@Buf7, 8),
{V44@V8,V44@Buf9}
end,
V44@Conv10 = binary_to_list(V44@V0),
{V44@Conv10,V44@Buf1}
end,
...
{Term,Remain} = begin
<<V45@V0:1/binary-unit:8,V45@Buf1/bitstring>> = Bytes,
V45@Conv2 = binary_to_list(V45@V0),
{V45@Conv2,V45@Buf1}
end,
...
dec_fragment71(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment71(Num, Bytes, Acc) ->
{Term,Remain} = dec_AmmDescriptor(Bytes),
dec_fragment71(Num-1, Remain, [Term|Acc]).

dec_fragment72(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment72(Num, Bytes, Acc) ->
{Term,Remain} = dec_IndAudPropertyParm(Bytes),
dec_fragment72(Num-1, Remain, [Term|Acc]).

dec_fragment73(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment73(Num, Bytes, Acc) ->
{Term,Remain} = dec_TopologyRequest(Bytes),
dec_fragment73(Num-1, Remain, [Term|Acc]).

dec_fragment74(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment74(Num, Bytes, Acc) ->
{Term,Remain} = dec_PropertyParm(Bytes),
dec_fragment74(Num-1, Remain, [Term|Acc]).

dec_fragment75(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment75(Num, Bytes, Acc) ->
{Term,Remain} = begin
<<V46@V0:2/unsigned-unit:1,V46@Buf1/bitstring>> = Bytes,
V46@Add2 = V46@V0 + 1,
V46@Pad5 = bit_size(V46@Buf1) band 7,
<<_:V46@Pad5,V46@V3:V46@Add2/unsigned-unit:8,V46@Buf4/bitstring>> = V46@Buf1,
{V46@V3,V46@Buf4}
end,
dec_fragment75(Num-1, Remain, [Term|Acc]).

dec_fragment76(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment76(Num, Bytes, Acc) ->
{Term,Remain} = dec_CommandReply(Bytes),
dec_fragment76(Num-1, Remain, [Term|Acc]).

dec_fragment77(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment77(Num, Bytes, Acc) ->
{Term,Remain} = begin
{V47@V0,V47@Buf1} = case Bytes of
<<0:1,V47@V3:4/unsigned-unit:1,V47@Buf4/bitstring>> ->
V47@Int5 = case V47@V3 of
0 -> v18;
1 -> v22;
2 -> v22bis;
3 -> v32;
...
7 -> v91;
8 -> synchISDN;
_ -> exit({error,{asn1,{decode_enumerated,V47@V3}}})
end,
{V47@Int5,V47@Buf4};
<<1:1,V47@Buf2/bitstring>> ->
{V47@V3,V47@Buf4} = case V47@Buf2 of
<<0:1,V47@V6:6,V47@Buf7/bitstring>> ->
{V47@V6,V47@Buf7};
<<1:1,V47@Buf5/bitstring>> ->
V47@Pad9 = bit_size(V47@Buf5) band 7,
{V47@V6,V47@Buf7} = case V47@Buf5 of
<<_:V47@Pad9,0:1,V47@V11:7,V47@Buf12/bitstring>> when V47@V11 =/= 0 ->
{V47@V11,V47@Buf12};
<<_:V47@Pad9,1:1,0:1,V47@V12:14,V47@Buf13/bitstring>> when V47@V12 =/= 0 ->
{V47@V12,V47@Buf13};
<<_:V47@Pad9,1:1,1:1,V47@V12:6,V47@Buf13/bitstring>> when V47@V12 =/= 0 ->
V47@Mul14 = V47@V12 * 16384,
{V47@Mul14,V47@Buf13}
end,
<<V47@V15:V47@V6/unit:8,V47@Buf16/bitstring>> = V47@Buf7,
{V47@V15,V47@Buf16}
end,
V47@Int17 = case V47@V3 of
_ -> {asn1_enum,V47@V3}
end,
{V47@Int17,V47@Buf4}
end,
...
dec_fragment77(Num-1, Remain, [Term|Acc]).

dec_fragment78(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment78(Num, Bytes, Acc) ->
{Term,Remain} = dec_CommandRequest(Bytes),
dec_fragment78(Num-1, Remain, [Term|Acc]).

dec_fragment79(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment79(Num, Bytes, Acc) ->
{Term,Remain} = dec_TransactionAck(Bytes),
dec_fragment79(Num-1, Remain, [Term|Acc]).

dec_fragment80(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment80(Num, Bytes, Acc) ->
{Term,Remain} = dec_ActionReply(Bytes),
dec_fragment80(Num-1, Remain, [Term|Acc]).

dec_fragment81(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment81(Num, Bytes, Acc) ->
{Term,Remain} = dec_ActionRequest(Bytes),
dec_fragment81(Num-1, Remain, [Term|Acc]).

dec_fragment82(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment82(Num, Bytes, Acc) ->
{Term,Remain} = dec_Transaction(Bytes),
dec_fragment82(Num-1, Remain, [Term|Acc]).

dec_fragment83(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment83(Num, Bytes, Acc) ->
{Term,Remain} = dec_PropertyParm(Bytes),
dec_fragment83(Num-1, Remain, [Term|Acc]).

dec_fragment84(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment84(Num, Bytes, Acc) ->
{Term,Remain} = dec_SigParameter(Bytes),
dec_fragment84(Num-1, Remain, [Term|Acc]).

dec_fragment85(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment85(Num, Bytes, Acc) ->
{Term,Remain} = dec_Signal(Bytes),
dec_fragment85(Num-1, Remain, [Term|Acc]).

dec_fragment86(0, Bytes, Acc) ->
{Acc,Bytes};
dec_fragment86(Num, Bytes, Acc) ->
{Term,Remain} = dec_SignalRequest(Bytes),
dec_fragment86(Num-1, Remain, [Term|Acc]).
